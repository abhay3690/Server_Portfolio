    ...
    <>
      <div className="font-light">
        ...
        <p className="text-lg  p-3  border border-indigo-500 rounded-[10px]">
          I'm a passionate Full Stack Devloper with a love for creating impactful webApplication
          that leave a lasting mark. <br /> My journey in web Application and Software Devlopment has
          ...
          , Bootstrap, and React for front-end tasks. On the back end,
          I've honed my skills in Node.js, Java, Spring-Boot, and databases like MySQL,
          , MongoDB. Git and GitHub are my go-to
          tools for version control. <br />
          Beyond coding, 
          {/* I've ventured into video editing and content creation */}
