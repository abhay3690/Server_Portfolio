...
function Homeleft() {
  const HomeGreeting = ["Youtuber", "Video Editor", "Fullstack Developer"];
  return (
    <>
      <div className="md:w-1/2  md:p-20 p-10 flex justify-center items-center">
        <div className="text-black  dark:text-white">
          <h1 className="mb-2 text-4xl font-bold">
            Hi, I'm <span className="text-indigo-600">Abhay A Suthar</span>
          </h1>
          ...
          <p className="mt-4 md:w-auto w-full text-[18px] text-gray-500 dark:text-gray-200  font-light">
            ...
            websites & WebApplication that make a lasting impact, leaving a
            digital footprint that tells a compelling story.
          </p>
